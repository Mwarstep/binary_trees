...
/**
 * sorted_array_to_avl - Will biud an avl tree from an array
 * @array: Pointer to the first element of the array to convert
 * @size: Number of elements in the array
 *
 * Return: Pointer to root node of created avl tree, otherwise NULL
 */
...
/**
 * sata_helper - The helper that builds an avl tree from an array
 * @root: Double pointer to the root node of subtree
 * @array: pointer to the first element of the array to convert
