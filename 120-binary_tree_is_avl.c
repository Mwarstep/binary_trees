...
/**
 * binary_tree_is_avl - Will find if a binary tree is an avl
...
/**
 * btia_helper - The helper that will find if a binary tree is an avl
 * @tree: Pointer to the root node of the tree
 * @min: The minimum value
 * @max: The maximum value
 *
 * Return: 1 if tree is an avl, otherwise 0
 */
