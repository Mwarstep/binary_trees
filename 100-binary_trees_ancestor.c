...
/**
 * binary_trees_ancestor - Will find the lowest commont ancestor of  2 nodes
 * @first: Pointer to first node to find ancestor
 ...
 *
 * Return: Depth of node, otherwise 0 if tree is NULL
 */
